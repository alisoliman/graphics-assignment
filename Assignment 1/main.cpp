...
//  Lab3
//
//  Created by Ali Soliman on 9/30/17.
...
void Display() {
    ...
    glColor3f(0,0,0);
    glBegin(GL_QUADS);
    glVertex3f(10.0f, 120.0f, 0.0f);
    glVertex3f(10.0f, 680.0f, 0.0f);
    glVertex3f(30.0f, 680.0f, 0.0f);
    glVertex3f(30.0f, 120.0f, 0.0f);
    glEnd();
    
    
    
    // Draw First Robotic Arm
    glPushMatrix();
    glColor3f(0,speC,1); //draws a blue pixel @ 10,220
    glTranslated(speX,speY,0);
    glBegin(GL_QUADS);
    glVertex3f(30.0f, 390.0f, 0.0f);
    glVertex3f(30.0f, 410.0f, 0.0f);
    glVertex3f(180.0f, 410.0f, 0.0f);
    glVertex3f(180.0f, 390.0f, 0.0f);
    glEnd();
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0,0,0); //draws a blue pixel @ 10,220
    glTranslated(speX,speY,0);
    glBegin(GL_QUADS);
    glVertex3f(180.0f, 300.0f, 0.0f);
    glVertex3f(180.0f, 500.0f, 0.0f);
...
// x and y are the position of the mouse cursor
{
    ...
    glutPostRedisplay();//redisplay to update the screen with the new parameters
}
